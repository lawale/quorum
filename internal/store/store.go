...
// ErrDuplicateRequest is returned by RequestStore.Create when a unique
// constraint violation occurs on the pending fingerprint index. This catches
// race conditions where two identical requests are created concurrently.
